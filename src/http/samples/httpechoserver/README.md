...
Demonstrates the LibSourcey HTTP server by echoing back the request body in the response. The header file (`httpechoserver.h`) contains several server variants:
